...
const FeatureCard = () => {
  ...
  return (
    <div className='grid grid-cols-1 px-3 sm:grid-cols-2 lg:grid-cols-3 gap-4'>
      {
        cards.map( item => {
            return <div key={item.id} className='p-10 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-11 duration-300transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-11 duration-300 rounded-xl group dark:bg-gray-700  boxHoverGradient hover:text-white  hover:cursor-pointer bg-gray-100'>
