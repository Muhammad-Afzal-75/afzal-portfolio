    ...
    import image1 from '../../assets/images/team7.jpg'
    import image2 from '../../assets/images/team8.jpg'
    import image3 from '../../assets/images/team9.jpg'
    import image4 from '../../assets/images/team10.jpg'
                                ...
                                {portfolio.map(item => (
                                    <div key={item.id} className='px-5 my-8 relative hover:scale-110 ease-in-out duration-300 delay-75'>
                                        ...
                                        <div className='absolute bottom-5 p-5 left-0 z-20 rounded '>
                                            ...
                                            <div><button className='text-white mt-9 ms-6 px-6 py-2 outline outline-2 outline-offset-2 hover:bg-red-500 hover:outline-0 rounded '>CASE STUDY</button></div>
